...
当前最新版本是0.9.4。redmine官方的[安装和配置文档](http://www.redmine.org/wiki/redmine/RedmineInstall)包含了linux和windows的配置，包括对系统需求。但可能文档不尽详尽，安装中会遇到很多问题。如果仅仅只是想体验下安装过程，并想知道怎么解决具体遇到的问题，可以参看我之前写的[redmine-0.9.x配置过程](/redmine-0-9-x-configuration-on-ubuntu)。
